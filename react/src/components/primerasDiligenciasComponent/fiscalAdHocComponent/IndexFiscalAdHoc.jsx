...
import ModalInformacionPrimeraDiligencia from '../../primerasDiligenciasComponent/fiscalAdHocComponent/ModalInformacionPrimeraDiligencia'; // Importa el componente ModalInformacionPrimeraDiligencia

function IndexFiscalAdHoc() {
    ...
    //endpoint
    const endpointBuscarPrimerasDiligencias = `${url}/api/primerasDiligencias/obtenerPrimeraDiligencias`; //endpoint para traer los formularios
    ...
    const [openModalAccionPrimeraDiligencia, setOpenModalAccionPrimeraDiligencia] = useState(false);

    // Abrir modal aplicar sancion
    const closeModalAccionPrimeraDiligencia = () => {
        setOpenModalAccionPrimeraDiligencia(false);
    };
    const handleAccionPrimeraDiligenciaClick = (primeraDiligencia) => {
        setPrimeraDiligenciaSeleccionada(primeraDiligencia);
        setOpenModalAccionPrimeraDiligencia(true);
    };

    const getAllPrimerasDiligencias = async () => {
        const response = await axios.get(`${endpointBuscarPrimerasDiligencias}?page=${currentPage}&search=${searchTerm}`);
    ...
    console.log(primerasDiligencias, "hola toy aki")
    ...
    return (
        <div>
                            ...
                            <div key={primeraDiligencia.id} className="bg-gray-300 rounded-lg shadow-md mb-6 p-4 hover:shadow-lg transition-shadow duration-300 border-2 border-gray-400 ">
                                ...
                                <div className="flex justify-end mt-2">
                                    <div className="flex gap-2">
                                        <button
                                            onClick={() => handleAccionPrimeraDiligenciaClick(primeraDiligencia)}
            ...
            <ToastContainer />
            <ModalInformacionPrimeraDiligencia
                getAllPrimerasDiligencias={getAllPrimerasDiligencias}
                primeraDiligenciaSeleccionada={primeraDiligenciaSeleccionada}
                openModalAccionPrimeraDiligencia={openModalAccionPrimeraDiligencia}
                closeModalAccionPrimeraDiligencia={closeModalAccionPrimeraDiligencia}
            />
...
export default IndexFiscalAdHoc
