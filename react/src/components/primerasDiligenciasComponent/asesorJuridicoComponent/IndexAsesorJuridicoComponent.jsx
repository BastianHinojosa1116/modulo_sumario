...
import ModalAccionAsesorJuridico from '../../primerasDiligenciasComponent/asesorJuridicoComponent/ModalAccionAsesorJuridico'; // Importa el componente ModalAccionAsesorJuridico

function IndexAsesorJuridicoComponent() {
    ...
    //endpoint
    const endpointBuscarPrimerasDiligenciasTramita = `${url}/api/primerasDiligencias/obtenerAsesorJuridico`; //endpoint para traer los formularios
...
export default IndexAsesorJuridicoComponent