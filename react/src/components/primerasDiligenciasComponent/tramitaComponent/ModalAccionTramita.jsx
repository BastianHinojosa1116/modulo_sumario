...
import FormCambiarEstadoTramita from '../tramitaComponent/FormCambiarEstadoTramita'; // Importa el componente ModalShowUser

function ModalAccionTramita({ openModalTramita, closeModalAccionTramita, primeraDiligenciaSeleccionada, getAllPrimerasDiligencias}) {
    return (
                ...
                <div className="fixed inset-0 overflow-y-auto flex items-center justify-center p-4">
                    ...
                    >
                        <Dialog.Panel className="w-full max-w-5xl mt-8 mb-8 max-h-[100vh] transform overflow-hidden rounded-xl bg-slate-200 text-left align-middle shadow-xl transition-all overflow-y-auto">
                            ...
                            {/* Contenido del modal */}
                            <div className="p-4">
                                <FormCambiarEstadoTramita primeraDiligenciaSeleccionada={primeraDiligenciaSeleccionada} closeModalAccionTramita={closeModalAccionTramita} getAllPrimerasDiligencias={getAllPrimerasDiligencias} />
                            </div>
                        </Dialog.Panel>
                    </Transition.Child>
                </div>
