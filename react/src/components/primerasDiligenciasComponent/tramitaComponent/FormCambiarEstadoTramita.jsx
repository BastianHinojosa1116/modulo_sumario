...
function FormCambiarEstadoTramita({ primeraDiligenciaSeleccionada, closeModalAccionTramita, getAllPrimerasDiligencias }) {

    const navigate = useNavigate();
    const { url } = useStateContext();
    const endpointRealizarAccion = `${url}/api/primerasDiligencias/tramita-select-cambiar-estado/`;
                    ...
                    <div className="bg-gray-300 rounded-lg shadow-md mb-6 p-4 hover:shadow-lg transition-shadow duration-300 border-2 border-gray-400 ">
                        ...
                        <div className="mt-2">
                            ...
                            >
                                ...
                                {/* Si el estado es prórroga */}
                                {primeraDiligenciaSeleccionada?.estado_primera_diligencia === 'Prórroga' && (
                                    <>
                                        <option value="Acepta prórroga">Acepta prórroga</option>
                                        <option value="Rechaza prórroga">Rechaza prórroga</option>
                                    </>
                                )}

                                {/* Si el estado es oficio informe */}
                                {primeraDiligenciaSeleccionada?.estado_primera_diligencia === 'Oficio informe' && (
                                    <option value="Revisión asesor jurídico">Revisión asesor jurídico</option>
                                )}

                                {/* Si el estado es Inhabilita */}
                                {primeraDiligenciaSeleccionada?.estado_primera_diligencia === 'Inhabilita' && (
                                    <>
                                        <option value="Acepta inhabilidad">Acepta inhabilidad</option>
                                        <option value="Rechaza inhabilidad">Rechaza inhabilidad</option>
                                    </>
                                )}

                                {/* Opciones comunes si las quieres siempre disponibles */}
                                {/* <option value="Dispone notificación">Dispone notificación</option>
...
export default FormCambiarEstadoTramita