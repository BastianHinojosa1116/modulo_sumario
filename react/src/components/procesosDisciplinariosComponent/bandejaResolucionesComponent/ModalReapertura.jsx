...
import FormReapertura from '../bandejaResolucionesComponent/FormReapertura';

function ModalReapertura({ show, closeModalReapertura, id }) {
    return (
        <Transition appear show={show} as={Fragment}>
            <Dialog as="div" className="relative z-10" onClose={closeModalReapertura}>
                <Transition.Child
                    as={Fragment}
                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-4xl mt-8 mb-8 h-full max-h-max transform overflow-hidden rounded-xl bg-slate-200 text-left align-middle shadow-xl transition-all overflow-y-auto">
                                ...
                                <div>
                                    <FormReapertura closeModalReapertura={closeModalReapertura} id={id} />
                                </div>
                            </Dialog.Panel>
                        </Transition.Child>
                    </div>
...
export default ModalReapertura;
