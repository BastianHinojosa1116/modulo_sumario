...
import FormAplicarSancion from '../resolverFaltaDisciplinariaComponent/FormAplicarSancion'; // Importa el componente ModalShowUser


function ModalAplicarSancion({ openModalAplicarSancion,
    closeModalAplicarSancion, id, numeroRolFalta, sanciones }) {
                    ...
                    <div className="flex min-h-full items-center justify-center p-1 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-4xl mt-8 mb-8 h-full max-h-max transform overflow-hidden rounded-xl bg-slate-200 text-left align-middle shadow-xl transition-all overflow-y-auto">
                                ...
                                >
                                    <span className='px-6'>Notificar Sanción</span>
                                ...
                                <div>
                                    <FormAplicarSancion id={id} sancionAplicada={sanciones} closeModalAplicarSancion={closeModalAplicarSancion} numeroRolFalta={numeroRolFalta} />
                                </div>
...
export default ModalAplicarSancion
