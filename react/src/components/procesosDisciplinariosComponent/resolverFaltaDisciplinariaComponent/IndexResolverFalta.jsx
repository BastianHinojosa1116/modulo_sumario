...
import { useStateContext } from '../../../contexts/ContextProvider'; // importa context provider

function IndexResolverFalta() {
    const [faltas, setFaltas] = useState([]);  //declaracion de variables
    ...
    const endpoint = `${url}/api/resolverFaltas`;
    ...
    const getAllFaltas = async () => {
        const response = await axios.get(`${endpoint}?page=${currentPage}&search=${searchTerm}&dotacion=${user.dotacion}`);
                                                ...
                                                <td className="py-2 px-4">
                                                    <div className="flex justify-center space-x-2">
                                                        ...
                                                        <Link
                                                            ...
                                                            to={`/procesosDisciplinarios/resolverFalta/aplicarSancion/${falta.id}`}
...
export default IndexResolverFalta
