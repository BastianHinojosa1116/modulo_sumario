...
function FormAsesorJuridico({ closeModalAsesorJurudico, id, numeroRolFalta }) {
    ...
    const endpointAsignarAsesorJuridico = `${url}/api/resolverFalta/aplicarSancion/asesorJuridico/`;
    ...
    const handleAsignarAsesorJuridico = async (e) => {
        ...
        formData.append('segundo_nombre', userData.apellido_paterno);
        formData.append('apellido_paterno', userData.primer_nombre);
        formData.append('apellido_materno', userData.segundo_nombre);
            ...
            <div className='ml-6 mr-6 mt-6 mb-4 p-8 bg-white rounded-lg border-2 border-gray-300'>
                ...
                <div className="space-y-2 w-full  p-4 px-8 rounded-lg border border-gray-400 shadow-md">
                    ...
                    <div className="flex space-x-4"> {/* Utilizamos flex para colocar los elementos en línea */}
                        ...
                        />
                        <button onClick={buscarUsuario} className="bg-green-700 hover:bg-green-500 text-white px-4 py-0 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-600 transition duration-500">
                            Buscar
                        </button>
                    </div>
                            ...
                            <div className="flex justify-start border-b-2 border-gray-200 p-4 shadow-md">
                                <div className="mb-2 sm:mb-0 sm:flex-shrink-0 sm:mr-4">
                                    <img
                                        ...
                                        alt="Usuario"
                                        className="max-w-40 h-40 ml-6 mt-4 mr-6 object-cover border bg-orange-50 rounded-full border-gray-300"
                                    />
                                </div>
...
export default FormAsesorJuridico
