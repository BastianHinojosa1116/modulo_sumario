...
function FormProcesoAdministrativo({ closeModalProcesoAdministrativo, id }) {
    ...
    const endpoint = `${url}/api/resolverFalta/aplicarSancion/procesoAdministrativo/`;
    ...
    const handleProcesoAdministrativo = async (e) => {
        e.preventDefault()
        ...
        try {
            ...
            closeModalProcesoAdministrativo();
...
export default FormProcesoAdministrativo
