...
import FormAsesorJuridico from '../sancionarFaltaComponent/FormAsesorJuridicoSancionarFalta'; // Importa el componente ModalShowUser

function ModalAsesorJuridicoSancionarFalta({ openModalAsesorJurudico, id, closeModalAsesorJurudico, numeroRolFalta }) {
    return (
...
export default ModalAsesorJuridicoSancionarFalta
