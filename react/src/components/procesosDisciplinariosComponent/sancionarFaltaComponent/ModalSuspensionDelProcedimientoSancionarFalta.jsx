...
import FormSuspensionDelProcedimientoSancionarFalta from '../sancionarFaltaComponent/FormSuspensionDelProcedimientoSancionarFalta'; // Importa el componente ModalShowUser

function ModalSuspensionDelProcedimientoSancionarFalta({ openModalSuspensionDelProcedimiento, id, closeModalSuspensionDelProcedimiento }) {
    return (
                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-4xl mt-8 mb-8 h-full max-h-max transform overflow-hidden rounded-xl bg-slate-200 text-left align-middle shadow-xl transition-all overflow-y-auto">
                                ...
                                <div>
                                    <FormSuspensionDelProcedimientoSancionarFalta closeModalSuspensionDelProcedimiento={closeModalSuspensionDelProcedimiento} id={id} />
                                </div>
...
export default ModalSuspensionDelProcedimientoSancionarFalta
