...
function VerFaltaConsulta() {
    ...
    console.log(asesorJuridico, "hola po")
                                    ...
                                    involucrado.map((involucrados, index) => (
                                        <tr key={index} className="border-b hover:bg-gray-200 transition-colors duration-500">
                                            ...
                                            <td className="py-2 px-4">  <div className="flex justify-center space-x-2">
                                                {/* agregar botones */}
                                                <Link
                                                    to={`/procesosDisciplinarios/consulta/verFalta/${falta.id}/involucrado/${involucrados.id}`}
                                                ...
                                                {asesoresJuridicos.documento_informe_juridico ? (
                                                    ...
                                                    <>
                                                        <div className="w-full md:w-2/5 flex justify-start ml-0 md:ml-8 p-4 border rounded-md border-gray-300 shadow-md">
                                                            <div className="w-full">
                                                                <h2 className="text-2xl font-semibold text-gray-700 mb-2 text-center">Visualizar informe jurídico</h2>
                                                                <p className='font-serif text-center text-gray-500 mb-4 mt-8'>En este momento no se puede visualizar el documento debido a que el asesor jurídico aun no realiza la carga de su informe jurídico.</p>
...
export default VerFaltaConsulta
